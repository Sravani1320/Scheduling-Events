        ...
        btngetpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Call<ResponseData> call = service.forgotPassword(textEmailAddress.getText().toString());
                    ...
                    call.enqueue(new Callback<ResponseData>() {
                        ...
                        public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                            if (response.body().status.equals("true")) {
                                Intent s=new Intent(StudentForgotPasswordActivity.this,StudentLoginActivity.class);
                                startActivity(s);
                                Toast.makeText(StudentForgotPasswordActivity.this, response.body().message.toString(), Toast.LENGTH_LONG).show();
                        ...
                        public void onFailure(Call<ResponseData> call, Throwable t) {
                            Toast.makeText(StudentForgotPasswordActivity.this, t.toString(), Toast.LENGTH_LONG).show();
