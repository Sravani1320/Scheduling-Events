...
public class StudentMyEventAdapter extends BaseAdapter {
    List<EventsPojo> event;
    Context con;
    String url= "http://paytracker.ca/events/";
    ProgressDialog progressDialog;

    public StudentMyEventAdapter(List<EventsPojo> event, Context con) {
        this.event = event;
        this.con = con;
    }
                ...
                call.enqueue(new Callback<ResponseData>() {
                    ...
                    public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                        ...
                        if(response.body()==null){
                            ...
                            Intent intent=new Intent(con, StudentHomeActivity.class);
                            con.startActivity(intent);
